...
class _AddEditShopScreenState extends ConsumerState<AddEditShopScreen> {
  ...
  Future<void> _handleSaveShop() async {
    ...
    if (!_gpsCaptured) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'Please capture shop GPS coordinates first for route validation.',
          ),
        ),
      );
      return;
    ...
    try {
      final currentSalesman = ref.read(salesmanProfileProvider).asData?.value;
      ...
      final newShop = Shop(
        ...
        approved: false, // Standard admin authorization loops trigger approvals
        active: true,
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Add Store Partner')),
          ...
          child: Column(
            ...
            children: [
              ...
              CustomTextField(
                ...
                validator: (v) =>
                    v == null || v.isEmpty ? 'Client name is required' : null,
              ),
              const SizedBox(height: 16),
              CustomTextField(
              ...
              CustomTextField(
                ...
                validator: (v) =>
                    v == null || v.isEmpty ? 'Store address is required' : null,
              ),
              const SizedBox(height: 16),
              Row(
                children: [
              ...
              CustomTextField(
                ...
                placeholder:
                    'Store constraints, off-peak times, specific GST requests...',
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (_gpsCaptured)
                              ...
                              const Text(
                                'Verifying satellites coordinates...',
                                style: TextStyle(
                                  fontSize: 12,
                              ...
                              const Text(
                                'GPS not captured. Move outside for exact tracking.',
